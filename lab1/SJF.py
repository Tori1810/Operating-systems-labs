...
def planning():
	...
	while True:
		...
		if (FREE_PROCESSOR and PROCESS_LIST):
			...
			BEST_ELEMENT = PROCESS_LIST[0]
			BEST_ELEMENT_INDEX = 0
			INDEX = -1
			for element in PROCESS_LIST:
				INDEX +=1
				if element.executive_time < BEST_ELEMENT.executive_time:
					BEST_ELEMENT = element
					BEST_ELEMENT_INDEX = INDEX
			CURRENT_PROCESS = PROCESS_LIST.pop(BEST_ELEMENT_INDEX)
			BEST_ELEMENT = []
